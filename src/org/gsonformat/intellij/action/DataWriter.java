...
public class DataWriter extends WriteCommandAction.Simple {
    ...
    public DataWriter(PsiFile file, Project project, PsiClass cls, boolean isDefaultValue) {
        super(project, file);
        factory = JavaPsiFacade.getElementFactory(project);
        this.file = file;
        this.project = project;
...
//                NotificationCenter.info(sb.toString());
    ...
    protected void run() {
        ...
        new ClassProcessor(factory, cls).generate(targetClass, this.isDefaultValue, new IProcessor() {
            @Override
