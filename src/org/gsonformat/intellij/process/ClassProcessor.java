...
public class ClassProcessor {
    ...
    public void generate(ClassEntity classEntity, boolean isDefaultValue, IProcessor visitor) {
        if (processor != null)
            processor.process(classEntity, factory, cls, visitor, isDefaultValue);
    }
}
