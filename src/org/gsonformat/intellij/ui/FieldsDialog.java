...
public class FieldsDialog extends JFrame {
    ...
    private JCheckBox ckbDefaultValue;
    ...
    private JCheckBox cbkDefaultValue;
...
//        treetable.setSelectionBackground(treetable.getBackground());
    ...
    private void onDefaultValueSelected() {
        ...
        WriteCommandAction.runWriteCommandAction(project, new Runnable() {
            ...
            public void run() {
                ...
                if (psiClass != null) {
                    ...
                    try {
                        setVisible(false);
                        DataWriter dataWriter = new DataWriter(file, project, psiClass, cbkDefaultValue.isSelected());
